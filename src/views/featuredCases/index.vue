<template>
    <div class="flex_column content content_box_shadow gap-6 py-6">
        <!-- 搜索和新增区域 -->
            ...
            <el-table :data="tableColumns" border style="width: 100%;box-sizing: border-box;flex: 1;">
                ...
                <el-table-column prop="image" label="图片" width="200" align="center">
                    <template #default="scope">
                        <el-image :src="scope.row.image" style="width: 50px; height: 50px;" alt=""/>
                    </template>
                </el-table-column>
...
// 搜索表单
const form = ref({name: '', is_featured: false});
// 对话框显示状态
...
// 重置
const init = () => {
    form.value = {name: '', is_featured: false};
    fetchData();
}
